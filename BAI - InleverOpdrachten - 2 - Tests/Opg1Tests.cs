...
using BAI___InleverOpdrachten___2;

namespace BAI
{
    [TestFixture]
    public class Opg1Tests
    {
        ...
        {
            // Act
            uint actual = Opdracht1.Vermogen(b);
        ...
        {
            // Act
            bool actual = Opdracht1.Vooruit(b);
